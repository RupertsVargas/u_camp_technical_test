...
export default function Card(props) {
    ...
    let { title, old_price, newPrice, dollar, exp_date,stock } = props
    let cssStock = stock <= 0 ? "outStock" : "inStock";
    let nameStock = stock <= 0 ? "No Disponible" : "Disponible";
    return (
                ...
                <div className="cardInfo">
                    ...
                    <div className="action">
                        <div className="priceGroup">
                            <p className={"stock "+cssStock }>{nameStock}</p>
